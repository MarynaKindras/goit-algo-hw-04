...
Timsort виявився найефективнішим алгоритмом сортування на всіх тестових наборах даних. Рекомендовано використовувати вбудовані функції sorted та sort для більшості завдань сортування в Python.
